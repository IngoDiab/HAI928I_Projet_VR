...
public class VFXManager : Singleton<VFXManager>
{
    ...
    public void InstantiateVFX(VFX_NAME _name, Vector3 _vfxPos, Quaternion _vfxRotation, Transform _parent)
    {
        PairNameVFX _vfxData = GetSoundByName(_name);
        if (_vfxData == null) return;
        ...
        if (!_vfxData.IsAutoDestroying()) return;
